        ...
        <form wire:submit="leerDatosFormulario">
            <div class="md:grid md:grid-cols-3 gap-5">
                ...
                <div class="mb-5">
                    ...
                    <select class="rounded-md shadow-sm border-gray-300 p-2 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" wire:model="categoria">
                ...
                <div class="mb-5">
                    ...
                    <select class="rounded-md shadow-sm border-gray-300 p-2 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 w-full" wire:model="salario">
                        <option value="">-- Seleccione --</option>
